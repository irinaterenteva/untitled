 ...
 /*
    ...
    public static ArrayList<Integer> sumFromString(ArrayList<String> list) {
        ...
        for (String each : list) { // goes through every element of the ArrayList from params
            ...
            for (String eachDigit : each.split("")) { //converting the String, each, to an arra by split with an empty space, it means the each String will be seperated with each character as separate String elements
