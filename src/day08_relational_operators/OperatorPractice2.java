...
public class OperatorPractice2 {
    public static void main(String[] args) {
        ...
        System.out.println(a--); //post decrement, first get the currrent value of a, which is 38 and prints it
        ...
        System.out.println(a--);  // post decrement, first get the currrent value of a, which is 35 and prints it
