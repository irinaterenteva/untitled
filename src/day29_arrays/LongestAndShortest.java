...
public class LongestAndShortest {
    ...
    â€¢ Write a program that can return the shortest string element from a String array
    â€¢ Write a program that can return the longest string element from a String array
     */
